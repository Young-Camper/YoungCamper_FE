  ...
  return (
    <>
      ...
      <S.ContentText $isDesktop={isDesktop}>
        ...
        <br />
        자승 스님께서는 대학생들에게 불교의 가르침을 널리 전파하고, 청년 불자
        <br />
        들이 마음껏 즐길 수 있는 축제의 장을 마련하고자 하셨습니다.
        <br />
        <br />
        스님의 입적 후, 돈관 이사장스님께서 이 염원을 이어 받아 영캠프가 성공
        <br />
        적으로 개최될 수 있게 물심양면 지원해 주셨습니다.
        <br />
        스님의 따뜻한 마음이 담긴 이 행사를 통해, 여러분 모두가 불교의 아름다
        <br />
        움과 깊이를 새롭게 느끼고, 함께하는 기쁨을 누리시길 바랍니다.
        <br />
        감사합니다.
        <br />
        <br />
